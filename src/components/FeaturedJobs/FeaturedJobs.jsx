...
const FeaturedJobs = () => {
    ...
    return (
        <div>
          <div>
          <h1 className=" text-2xl lg:text-5xl text-center text-[#1A1919] font-semibold lg:font-extrabold ">Featured Jobs</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 my-12 lg:my-24">
